...
async def handle_message(message, db, client):
    ...
    elif lower_message.startswith('!order ') or lower_message.startswith('!leagueorder '):
        await league_order_handler(db, message, context)
    ...
    elif lower_message == '!delteaminfo' and is_admin:
        await delete_team_info_handler(client, db, message, context)
    ...
    elif lower_message.startswith('!vstartauction') and is_admin:
        await v_start_auction_handler(db, message, client)
    ...
    # !matchend winTeam winScore loseTeam loseScore
        ...
        await route_dbd_message(client, db, message, lower_message, is_admin)
