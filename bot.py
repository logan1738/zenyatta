...
def is_valid_channel(message, lower_message, is_helper, is_push_bot, is_tourney_admin):
    ...
    if lower_message == '!p' or lower_message == '!hello' or lower_message == '!pingteam' or lower_message == '!gg ez' or lower_message.startswith('!help') or lower_message.startswith('!whichteam'):
        return True, None
...
async def handle_message(message, db, client):
    ...
    # LEAGUE COMMANDS
        ...
        await fix_mr_lineup_hander(db, message)
    ...
    # ADMIN COMMANDS
        ...
        await remove_passes_handler(db, message)
    ...
    # !matchend winTeam winScore loseTeam loseScore
        ...
        await give_all_boxes_hander(db, message, client)
