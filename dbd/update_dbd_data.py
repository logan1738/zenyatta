...
def generate_allowed_killer_perks(killer):

    all_perk_array = get_all_killer_perk_names()

    allowed_perks = []

    base_banned_perks = KILLER_BASE_BANNED_PERKS
    tier_banned_perks = get_killer_perk_bans_for_tier(killer.TIER)
    killer_specific_banned_perks = killer.BANNED_KILLER_PERKS
