...
class SPIRIT:
    ...
    # THIS IS NOT A REAL BANNED COMBO, ITS JUST FOR TESTING, MAKE SURE TO REMOVE LATER
    BANNED_SURVIVOR_PERK_COMBOS = [[SURVIVOR_PERK_NAMES.BOND, SURVIVOR_PERK_NAMES.BOIL_OVER]]
